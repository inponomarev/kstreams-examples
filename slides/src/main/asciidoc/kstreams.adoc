...
== Копартиционирование: Join работает
...
== Разное число партиций: Join не работает (Runtime Exception)
...
== Разный алгоритм партицирования: Join не работает молча!
...
== GlobalKTable: реплицируется всюду целиком
