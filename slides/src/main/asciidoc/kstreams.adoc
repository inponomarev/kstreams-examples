...
Sum -> Store [dir=both; label=" \n "]
{rank = same; Store; Sum;}
Store -> Changelog[style="dotted"]
Changelog[shape="ellipse"; style="dotted"]
}
-----
...
Guozhang Wang: Performance Analysis and Optimizations for Kafka Streams Applications
