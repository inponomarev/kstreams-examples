...
image::derivative.png[{image-70-width}]
...
rankdir="LR";
node [fontsize=18; shape="circle"; fixedsize="true"; width="1.1"];
Store1 [shape="cylinder"; label="Local Store 1"; fixedsize="true"; width="1.6"]
Store2 [shape="cylinder"; label="Local Store 2"; fixedsize="true"; width="1.6"]
Source1 -> Join
Source2 -> Join
